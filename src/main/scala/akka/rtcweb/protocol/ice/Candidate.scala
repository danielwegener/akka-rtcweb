 ...
 * @param port It is the port of the candidate.
 ...
 * @param relayPort @see [[relayConnectionAddress]]
...
final case class Candidate(
    ...
    relayPort: Option[Int],
    extensionAttributes: Seq[Candidate.ExtensionAttribute]) extends sdp.ExtensionAttribute {
